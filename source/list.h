 ...
 */
static void __list_add(struct list_head *newone,
 ...
 */
static   void list_add(struct list_head *newone, struct list_head *head)
{
 ...
 */
static   void list_add_tail(struct list_head *newone, struct list_head *head)
{
